...
public class MonticuloBinario {
    ...
    /**
     * Un procedimiento que inserta una impresión a la cola, redimensionando si es necesario.
     * @param imp 
     */
    ...
    /**
     * Este procedimiento recibe una impresión especifica y le pone un valor minimo de prioridad, lo flota hasta el tope y lo elimina sin imprimir.
     ...
     * @param i Un entero que es el índice del nodo actual en el arreglo (basado en 1).
    ...
    /**
     * Una función que elimina la impresión con la minima prioridad, manteniendo el orden intercambiendo el ultimo elemento con el primero asi no se elimina la raiz.
    ...
    /**
     * Una función que retorna la impresión con la menor prioridad (menor prioridad significa primero en el heap).
     ...
     * @param i Un entero que es el indice de uno de los elementos que se desea intercambiar.
     * @param j Un entero que es el indice de uno de los elementos que se desea intercambiar.
     */
    ...
    /**
     * Un procedimiento que 'hunde' un elemento de indice i hasta que sus hijos no sean menores o hasta que el elemento sea menor o igual que sus hijos.
     ...
     * @return Un booleano que es verdadero si no tiene un elemento adentro, o falso si hay almenos uno.
     */
    ...
    /**
     * Un procedimiento que recibe un array de impresiones y las inserta en el monticulo.
    ...
    /**
     * Un procedimiento que recibe un entero y lo asigna como el contador de tamaño del monticulo.
     * @param iN 
     */
